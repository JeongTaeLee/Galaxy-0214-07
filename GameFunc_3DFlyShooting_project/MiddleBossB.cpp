...
void MiddleBossB::Init()
{
	MainMonster::Init();

	lpRenderer->LoadMesh(IMAGE.LoadObjFile("MiddleBossA", "./rs/obj/MiddleBossA/A_.obj"));
	lpApperaTexture = IMAGE.LoadTexture("MiddleBossBAppear", "./rs/Sprite/UI/2Stage_MidBoss.png");

	lpCollider->InitSphere(Vector3(0.f, 0.f, 0.f), 100);
}

void MiddleBossB::Move()
{
...
void MiddleBossB::Die()
{
	GAMEMANAGER.SetMission(10);
}

void MiddleBossB::AttackType01()
{
